...
- 悬浮窗服务
  - 在 **APP-高级设置-快照按钮** 点击弹窗授权开启**悬浮窗服务权限**后, 此时界面会出现一个**快照按钮**<img src="./images/quick-start/00_Get-snapshot-by-float-button.webp" width="28" height="28" alt="通过悬浮按钮获取快照">, 点击这个按钮即可**截取目标应用快照**
